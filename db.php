...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>si664f12/db.php at c2ab1570eb85244bfac537deac4a15bb77709168 · jpobley/si664f12</title>
...
<meta content="D6H0eiXpXgNijFpueMhS1mmfMKTPKQCcDL3q+szygrc=" name="csrf-token" />
    ...
    <script src="https://a248.e.akamai.net/assets.github.com/assets/github-91075f957a1f33e3f4fb4ee831540fc563718237.js" type="text/javascript"></script>
      ...
      <link rel='permalink' href='/jpobley/si664f12/blob/c2ab1570eb85244bfac537deac4a15bb77709168/db.php'>
          ...
          <div class="js-filter-tab js-filter-branches" data-filterable-for="context-commitish-filter-field" data-filterable-type=substring>
            <div class="no-results js-not-filterable">Nothing to show</div>
              <div class="commitish-item branch-commitish selector-item js-navigation-item js-navigation-target ">
                <span class="mini-icon mini-icon-confirm"></span>
                <h4>
                    <a href="/jpobley/si664f12/blob/master/db.php" class="js-navigation-open" data-name="master" rel="nofollow">master</a>
                </h4>
              </div>
          </div>
...
<!-- blob contrib key: blob_contributors:v21:c486b0329bfbcfba1e755efae7e6133a -->
<!-- blob contrib frag key: views10/v8/blob_contributors:v21:c486b0329bfbcfba1e755efae7e6133a -->

<div id="slider">

    <div class="breadcrumb" data-path="db.php/">
      <b itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/jpobley/si664f12/tree/c2ab1570eb85244bfac537deac4a15bb77709168" itemscope="url" rel="nofollow"><span itemprop="title">si664f12</span></a></b> / <strong class="final-path">db.php</strong> <span class="js-clippy mini-icon mini-icon-clippy " data-clipboard-text="db.php" data-copied-hint="copied!" data-copy-hint="copy to clipboard"></span>
    </div>

      
  <div class="commit file-history-tease" data-path="db.php/">
    ...
    <time class="js-relative-date" datetime="2012-10-26T19:26:39-07:00" title="2012-10-26 19:26:39">October 26, 2012</time>
    <div class="commit-title">
        <a href="/jpobley/si664f12/commit/9f6948a78bbca4c8d7f24e15e5946f35d8df5dcf" class="message">Made a new page called create-eval.php that will eventually be the ev…</a>
    </div>
    ...
    <div class="frames">
      <div class="frame frame-center" data-path="db.php/" data-permalink-url="/jpobley/si664f12/blob/c2ab1570eb85244bfac537deac4a15bb77709168/db.php" data-title="si664f12/db.php at c2ab1570eb85244bfac537deac4a15bb77709168 · jpobley/si664f12 · GitHub" data-type="blob">
          ...
          <div class="file">
            <div class="meta">
              ...
              <ul class="button-group actions">
                  <li>
                    <a class="grouped-button file-edit-link minibutton bigger lighter" href="/jpobley/si664f12/edit/c2ab1570eb85244bfac537deac4a15bb77709168/db.php" data-method="post" rel="nofollow" data-hotkey="e">Edit</a>
                  </li>
                <li>
                  <a href="/jpobley/si664f12/raw/c2ab1570eb85244bfac537deac4a15bb77709168/db.php" class="minibutton grouped-button bigger lighter" id="raw-url">Raw</a>
                </li>
                  <li>
                    <a href="/jpobley/si664f12/blame/c2ab1570eb85244bfac537deac4a15bb77709168/db.php" class="minibutton grouped-button bigger lighter">Blame</a>
                  </li>
                <li>
                  <a href="/jpobley/si664f12/commits/c2ab1570eb85244bfac537deac4a15bb77709168/db.php" class="minibutton grouped-button bigger lighter" rel="nofollow">History</a>
                </li>
              </ul>
            </div>
...
<span id="L5" rel="#L5">5</span>
          ...
          <td width="100%">
                <div class="highlight"><pre><div class='line' id='LC1'><span class="o">&lt;?</span><span class="nx">php</span></div><div class='line' id='LC2'><span class="nv">$db</span> <span class="o">=</span> <span class="nb">mysql_connect</span><span class="p">(</span><span class="s2">&quot;localhost&quot;</span><span class="p">,</span><span class="s2">&quot;root&quot;</span><span class="p">,</span> <span class="s2">&quot;root&quot;</span><span class="p">);</span></div><div class='line' id='LC3'><span class="k">if</span> <span class="p">(</span> <span class="nv">$db</span> <span class="o">===</span> <span class="k">FALSE</span> <span class="p">)</span> <span class="k">die</span><span class="p">(</span><span class="s1">&#39;Could not connect to database&#39;</span><span class="p">);</span></div><div class='line' id='LC4'><span class="k">if</span> <span class="p">(</span> <span class="nb">mysql_select_db</span><span class="p">(</span><span class="s2">&quot;sicourserate&quot;</span><span class="p">)</span> <span class="o">===</span> <span class="k">FALSE</span> <span class="p">)</span> <span class="k">die</span><span class="p">(</span><span class="s2">&quot;Could not connect to database&quot;</span><span class="p">);</span></div><div class='line' id='LC5'><span class="cp">?&gt;</span><span class="x"></span></div></pre></div>
          </td>
        </tr>
      </table>
  </div>
...
<div class="lower_footer">
  <div class="container clearfix">
    <div id="legal">
      ...
      <p>&copy; 2012 <span title="0.06090s from fe17.rs.github.com">GitHub</span> Inc. All rights reserved.</p>
...
`&lt;addr&gt;` element here instead.</pre>
    ...
    <span id='server_response_time' data-time='0.06248' data-host='fe17'></span>
